...
<head>
    ...
    <style>
        ...
        /* Opsional: kasih latar belakang ringan */
        .nav-content a.active {
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="icons-nav" class="nav-content collapse {{ request()->is('konselor/*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="{{ route('konselor.task_berat') }}" class="nav-link {{ request()->is('konselor/task_berat') ? 'active' : '' }}">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h5 class="card-title mb-1">📋 Task Berat</h5>
                                    <small class="text-muted">Daftar konten task berat yang diunggah oleh konselor.</small>
                                </div>
                                <a href="{{ route('konselor.task_berat.create') }}" class="btn btn-success">
                                    ➕ Tambah Task
                                </a>
                            </div>

                            <div class="table-responsive">
                                <table id="taskBeratTable" class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="ratio ratio-16x9">
                                                                    ...
                                                                    <form id="form-complete-{{ $task->id }}" action="{{ route('progress.berat.complete', ['taskId' => $task->id]) }}" method="POST" style="display: none;">
                                                                        @csrf
                                                                    </form>
                                                                </div>
                                                            </div>
                                            ...
                                            <td>
                                                <a href="{{ route('konselor.task_berat.edit', $task->id) }}" class="btn btn-sm btn-warning me-1">✏️ Edit</a>
                                                <form action="{{ route('konselor.task_berat.delete', $task->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin ingin menghapus task ini?')">
                                                    @csrf
                                                    @method('DELETE')
