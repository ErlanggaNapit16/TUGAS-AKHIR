...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('konselor/pengumuman') ? 'active' : '' }}" href="{{ url('/konselor/pengumuman') }}">
    ...
    <section class="section">
      <div class="card">
        <div class="card-body">
          ...
          <p>Berikut adalah daftar pengumuman terbaru terkait kegiatan konseling dan edukasi.</p>

          <!-- Tombol Tambah Pengumuman (Dipindahkan ke kiri) -->
          <div class="mt-4">
            <a href="{{ route('konselor.create') }}" class="btn btn-secondary">Tambah Pengumuman</a>
          </div>
          ...
          <table class="table table-striped mt-3">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ \Illuminate\Support\Str::words($announcement->content, 15, '...') }}</td>
                <td>
                ...
                <td>
                  <div class="d-flex gap-2">
                    <!-- Tombol Lihat -->
                    <a href="{{ route('konselor.pengumuman.detail', $announcement->id) }}" class="btn btn-info btn-sm">Lihat</a>

                    <!-- Tombol Edit -->
                    <a href="{{ route('konselor.edit', $announcement->id) }}" class="btn btn-warning btn-sm">Edit</a>

                    <!-- Tombol Hapus -->
                    <form action="{{ route('konselor.destroy', $announcement->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengumuman ini?');">
                      @csrf
                      @method('DELETE')
