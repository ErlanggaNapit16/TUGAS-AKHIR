...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('konselor/schedule') ? 'active' : '' }}" href="{{ url('/konselor/schedule') }}">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Daftar Keluhan Pengguna</h5>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>08***2421</td>
                                        <td>Stres</td>
                                        <td><button class="btn btn-success btn-sm">DONE</button> <button class="btn btn-secondary btn-sm">Reschedule</button></td>
                                    </tr>
                                    <tr>
